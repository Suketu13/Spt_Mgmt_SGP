<%@ Page Title="" Language="C#" MasterPageFile="~/Sport.Master" AutoEventWireup="true" CodeBehind="CSgoDetails.aspx.cs" Inherits="temperory.CSgoDetails" %>
     ...
     <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body" runat="server">
                  <h4 class="card-title">Info Of CSgo</h4>
