<%@ Page Title="" Language="C#" MasterPageFile="~/Sport.Master" AutoEventWireup="true" CodeBehind="TabletennisDetails.aspx.cs" Inherits="temperory.TabletennisDetails" %>
     ...
     <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body" runat="server">
                  <h4 class="card-title">Info Of Tabletennis</h4>
