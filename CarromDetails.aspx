<%@ Page Title="" Language="C#" MasterPageFile="~/Sport.Master" AutoEventWireup="true" CodeBehind="CarromDetails.aspx.cs" Inherits="temperory.CarromDetails" %>
    ...
    <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body" runat="server">
                  <h4 class="card-title">Info Of Carrom</h4>
