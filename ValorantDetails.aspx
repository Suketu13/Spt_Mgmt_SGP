<%@ Page Title="" Language="C#" MasterPageFile="~/Sport.Master" AutoEventWireup="true" CodeBehind="ValorantDetails.aspx.cs" Inherits="temperory.ValorantDetails" %>
     ...
     <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body" runat="server">
                  <h4 class="card-title">Info Of Valorant</h4>
